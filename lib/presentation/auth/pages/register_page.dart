...
class _RegisterPageState extends State<RegisterPage>
  ...
  final GetuserBloc _getuserBloc = GetuserBloc(AuthUserRemoteDatasource());
  final RegisteruserBloc _registeruserBloc =
      RegisteruserBloc(AuthUserRemoteDatasource());
  ...
  void _onClickRegister() {
    if (userIdController.text.isNotEmpty &&
      ...
      _registeruserBloc.add(RegisteruserEvent.registeruser(
