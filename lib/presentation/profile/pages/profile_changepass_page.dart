...
class _ProfileForgotPasswordPageState extends State<ProfileForgotPasswordPage> {
  ...
  void _onClickGantiPass() async {
    if (_emailChangeController.text.isNotEmpty &&
      ...
      if (mounted) {
        context.read<ResetpasswordBloc>().add(ResetpasswordEvent.resetpassword(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        suffixIcon: IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              _isShowPasswordChange1 = !_isShowPasswordChange1;
                            });
                          },
                        ),
                      ),
                      ...
                      CustomTextField(
                        ...
                        suffixIcon: IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              _isShowPasswordChange2 = !_isShowPasswordChange2;
                            });
                          },
                        ),
                      ),
